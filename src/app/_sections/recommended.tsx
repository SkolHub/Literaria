...
export default async function () {
  ...
  return (
    <section className='section flex-col pb-4 pt-20 mobile:pb-2' id='recommended'>
      ...
      <div className='box-border hidden w-full grow flex-col gap-3 overflow-hidden px-4 py-0 mobile:flex'>
        ...
        <div className='flex max-h-[150px] gap-3'>
          <SpotlightCardMobile className='w-0 grow' article={articles[1].Article} />
          <SpotlightCardMobile className='w-0 grow' article={articles[2].Article} />
        </div>
      </div>
      <Link
        href='/#latest'
